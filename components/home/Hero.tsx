      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <Link
             href={home.hero.primaryButtonLink}
            ...
            <Link
              href={home.hero.secondaryButtonLink}
              className="
                mt-10 inline-block rounded-full border border-brand-coral px-8 py-4
                text-center text-sm font-bold uppercase tracking-[0.16em] text-green
                transition-all duration-300 ease-out
                hover:-translate-y-4 hover:scale-[1.04] hover:bg-brand-pink
                active:translate-y-[2px] active:scale-[0.97]
                [transition-timing-function:cubic-bezier(.175,.885,.32,1.275)]
